...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.authorizeRequests().antMatchers("/api/v1/login/**", "/api/v1/logout/**",
      "/api/v1/users/create", "/api/v1/token/refresh/**", "/api/v1/users/password/forget", "/api/v1/healthcheck/**").permitAll();
